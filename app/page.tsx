    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      <div className="flex flex-col items-center gap-8 max-w-4xl">
        <div className="text-justify text-sm font-bold text-gray-700 leading-relaxed">
          ...
          . This page provides a cryptographically secure, privacy-focused tool for organizing Secret Santa Gift Exchanges at scale, and is hosted on Railway directly from its Github repository, from which it can be downloaded and verified:{" "}
          <a
